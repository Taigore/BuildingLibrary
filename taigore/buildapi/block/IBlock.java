...
public interface IBlock
{
     ...
     * A copy means that a series of subsequent calls to this interface methods should return
     * the same results in the same order for both the original and the copy.
